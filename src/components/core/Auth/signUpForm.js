  ...
  return (
    <div>
      ...
      <form onSubmit={handleOnSubmit} className="flex w-full flex-col gap-y-4">
        <div className="flex gap-x-4">
          <label>
            ...
            <input
              ...
              className="w-full rounded-[0.5rem] bg-bistre p-[12px] text-peach-300 "
            />
          </label>
          <label>
            <p className="mb-1 text-[0.875rem] leading-[1.375rem] text-black">
        ...
        <div className="flex gap-x-4">
          <label className="relative">
            ...
            <input
              ...
              className="w-full rounded-[0.5rem] bg-bistre p-[12px] pr-10 text-peach-300 "
            />
            <span
        ...
        <button
          type="submit"
          className="mt-6 rounded-[8px] border-2  bg-yellow-50 py-[8px] px-[12px] font-medium text-richblack-900"
        >
          Create Account
        </button>
      </form>
